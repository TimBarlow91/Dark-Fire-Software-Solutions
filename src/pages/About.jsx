                ...
                <section className="bg-black py-16 text-white px-4">
                    <div className="max-w-5xl mx-auto rounded-xl border-3 border-gray-700 shadow-lg shadow-gray-600/100 backdrop-blur-sm bg-black/70 p-8">
                        ...
                        <div className="max-w-4xl mx-auto space-y-6">
                            <motion.p className="text-lg md:text-xl text-gray-300" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.2 }} viewport={{ once: true }}>
                            ...
                            <motion.p className="text-lg md:text-xl text-gray-300" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.4 }} viewport={{ once: true }}>
                            ...
                            <motion.p className="text-lg md:text-xl text-gray-300" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.6 }} viewport={{ once: true }}>
                                Let us ignite your digital transformation and bring your visionary ideas to life.
                            </motion.p>
                            <motion.p className="text-lg md:text-xl text-gray-300" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.8 }} viewport={{ once: true }}>
